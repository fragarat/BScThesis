...
In this experiment, $\mathbf{A}(t)$ is constructed based on the ordered and non-overlapping time intervals defined by $t_i\coloneqq[(i − 1)\tau , (i − 1 + 0.9)\tau )$, for $i=0, 1, \dots , 7$, and $\tau =0.1$ resulting in all the adjacency matrices have unitary spectral radius.
